...
public class DataLoader implements ApplicationRunner {
    ...
    Advert advert1 = new Advert("iphone6.png", "iPhone 6 with 64gb memory", "iPhone 6", Category.ELECTRONICS, 10000, new Date(2323223232L), false, seller1);
        advertRepository.save(advert1);
        Seller seller2 = new Seller("Jim", "Bob", "01592876789", "jimbob@work.com", "New Town");
        sellerRepository.save(seller2);

        Advert advert2 = new Advert("hammer.png", "Rusty hammer", "Hammer", Category.HOME, 1000, new Date(2323223232L), false, seller2);
